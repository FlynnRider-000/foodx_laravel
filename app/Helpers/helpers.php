...
/**
 * generate shipping_method column for datatable
 * @param $column
 * @return string
 */
function getShippingMethodColumn($column, $attributeName)
{
    if (isset($column)) {
        if ($column[$attributeName]) {
            return "<span class='badge badge-info'>" . trans('lang.market_limited_shipping') . "</span>";
        } else {
            return "<span class='badge badge-warning'>" . trans('lang.market_free_shipping') . "</span>";
        }
    }
}
