...
class MarketDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $dataTable = $dataTable
            ...
            ->editColumn('shipping_method', function($product) {
                return getShippingMethodColumn($product, 'shipping_method');
            })
            ->editColumn('pay_on_pickup', function($product) {
                return getBooleanColumn($product, 'pay_on_pickup');
            })
            ->editColumn('free_shipping', function ($product) {
                return getBooleanColumn($product, 'free_shipping');
            })
            ->editColumn('limited_shipping', function ($product) {
                return getBooleanColumn($product, 'limited_shipping');
            })
    ...
    protected function getColumns()
    {
        $columns = [
            ...
            [
                'data' => 'pay_on_pickup',
                'title' => trans('lang.market_pay_on_pickup'),
                'searchable' => false,
            ],
            [
                'data' => 'shipping_method',
                'title' => trans('lang.shipping_method'),

            ],
            [
                'data' => 'free_shipping',
                'title' => trans('lang.market_free_shipping'),
                'searchable' => false,
            ],
            [
                'data' => 'limited_shipping',
                'title' => trans('lang.market_limited_shipping'),
                'searchable' => false,
            ],
            [
                'data' => 'mini_order',
                'title' => trans('lang.market_mini_order'),
                'searchable' => false,
            ],
            [
                'data' => 'updated_at',
