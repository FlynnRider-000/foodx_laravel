...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <!-- worktime Field -->
    <div class="form-group row ">
        {!! Form::label('worktime', trans("lang.market_worktime"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-4">
            {!! Form::text('market_open_time', null,  ['class' => 'form-control','id' => 'market_open_time', 'placeholder'=>  trans("lang.market_open_time_placeholder")]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.market_open_time_help") }}
            </div>
        </div>
        <div class="col-4 offset-1">
            {!! Form::text('market_close_time', null,  ['class' => 'form-control','id' => 'market_close_time', 'placeholder'=>  trans("lang.market_close_time_placeholder")]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.market_close_time_help") }}
            </div>
        </div>
    </div>          
    ...
    <!-- 'Boolean available_for_pay_on_pickup Field' -->
    <div class="form-group row ">
        {!! Form::label('pay_on_pickup', trans("lang.market_pay_on_pickup"),['class' => 'col-3 control-label text-right']) !!}
        <div class="checkbox icheck">
            <label class="col-9 ml-2 form-check-inline">
                {!! Form::hidden('pay_on_pickup', 0) !!}
                {!! Form::checkbox('pay_on_pickup', 1, null) !!}
            </label>
        </div>
    </div>
    
    <!-- 'Boolean shipping_method Field' -->
    <div class="form-group row ">
        {!! Form::label('shipping_method', trans("lang.shipping_method"),['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::select('shipping_method', (object) array("0" => trans("lang.market_free_shipping"), "1" => trans("lang.market_limited_shipping")), null, ['class' => 'select2 form-control']) !!}
            <div class="form-text text-muted">{{ trans("lang.shipping_method_help") }}</div>
        </div>
    </div>

    <!-- 'Boolean available_for_free_shipping Field' -->
    <div class="form-group row ">
        {!! Form::label('free_shipping', trans("lang.market_free_shipping"),['class' => 'col-3 control-label text-right']) !!}
        <div class="checkbox icheck">
            <label class="col-9 ml-2 form-check-inline">
                {!! Form::hidden('free_shipping', 0) !!}
                {!! Form::checkbox('free_shipping', 1, null) !!}
            </label>
        </div>
    </div>

    <!-- 'Boolean available_for_limited_shipping Field' -->
    <div class="form-group row ">
        {!! Form::label('limited_shipping', trans("lang.market_limited_shipping"),['class' => 'col-3 control-label text-right']) !!}
        <div class="checkbox icheck">
            <label class="col-9 ml-2 form-check-inline">
                {!! Form::hidden('limited_shipping', 0) !!}
                {!! Form::checkbox('limited_shipping', 1, null) !!}
            </label>
        </div>
    </div>
</div>
...
<div class="col-12 custom-field-container">
    ...
    <div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
        ...
        <!-- mini_order Field -->
        <div class="form-group row ">
            {!! Form::label('mini_order', trans("lang.market_mini_order"), ['class' => 'col-3 control-label text-right']) !!}
            <div class="col-9">
                {!! Form::number('mini_order', null,  ['class' => 'form-control', 'step'=>'any', 'placeholder'=>  trans("lang.market_mini_order_placeholder")]) !!}
                <div class="form-text text-muted">
                    {{ trans("lang.market_mini_order_help") }}
                </div>
            </div>
        </div>
        <div class="form-group row ">
