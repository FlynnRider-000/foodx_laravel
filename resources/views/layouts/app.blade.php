...
<audio id="audio" muted autoplay>
    <source src="{{asset('dist/sound/alertSound.mp3')}}" type="audio/mpeg">
</audio>
@if(auth()->check())
    <div class="wrapper">
        <!-- Main Header -->
        ...
        <div class="alert alert-info alert-dismissible" id="newOrderAlert" style="display:none; width: 20%; min-width: 300px; position: fixed; right:20px; top: 50px; z-index:10000;">
            <button type="button" class="close alertClose">&times;</button>
            <strong>Note!</strong> <br/> You have new order
        </div>
