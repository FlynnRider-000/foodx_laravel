...
<!-- Price Field -->
    ...
    <!-- Priority Field -->
    <div class="form-group row ">
        {!! Form::label('priority', trans("lang.product_priority"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::number('priority', null,  ['class' => 'form-control','placeholder'=>  trans("lang.product_priority_placeholder"),'step'=>"any", 'min'=>"0"]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.product_priority_help") }}
            </div>
        </div>
    </div>
