    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-itema ctive"><a href="{!! route('carts.index') !!}">{{trans('lang.cart_plural')}}</a>
          </li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
    ...
    <div class="card-body">
      <div class="row">
        ...
        <div class="form-group col-12 text-right">
          <a href="{!! route('carts.index') !!}" class="btn btn-default"><i class="fa fa-undo"></i> {{trans('lang.back')}}</a>
        </div>
      </div>
