...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <!-- Checkout Note Field -->
    <div class="form-group row ">
        {!! Form::label('check_out_note', trans("lang.check_out_note"),['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::text('check_out_note', null,  ['class' => 'form-control', 'placeholder'=>  trans("lang.check_out_note_placeholder")]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.check_out_note_help") }}
            </div>
        </div>
    </div>
